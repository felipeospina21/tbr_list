			...
			<div className={styles.storyGrid}>
				<div className={styles.storyIntro}>
					...
					<p className={styles.storyCopy}>
						This page is designed to feel closer to a literary cover spread than
						a dashboard. It gives the app a stronger first impression while
				...
				<CardContent className={styles.ctaContent}>
					<div className={styles.ctaIntro}>
						...
						<p className={styles.ctaCopy}>
							Use this landing route as a polished front door while the main app
		...
		>
			<div className={styles.intro}>
				...
				<p className={styles.lede}>
					TBR List is a quiet reading queue for people who care about sequence.
					Add books, reorder them by mood, and keep the whole list available on
					mobile without losing clarity.
				</p>
						...
						<div className={styles.bookList}>
							{[
								...
								<div
									...
									className={cn(
										styles.bookItem,
										index === 0 ? styles.bookItemTop : styles.bookItemRegular,
									)}
								>
									<div className={styles.bookRow}>
										...
										<div className={styles.bookMetaWrap}>
											<div className={styles.bookMetaRow}>
												...
												<span className={styles.bookEnergy}>{book.energy}</span>
											</div>
										</div>
									</div>
								</div>
